...
namespace Management
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //Create movie objects and add to the database
            ...
            //Confirmed addition of objects to database
            ...
            //Keep getting an error that PresentationFramework file cannot be found, have been troubleshooting it and haven't been able to find a solution
            //This kinda means that the rest of the code might be a little useless since I can't test it, but if you can find a solution to the error
            //I think the queries should work fine
        }
    }
}
